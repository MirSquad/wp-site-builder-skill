...
| `references/performance-accessibility.md` | Before finalizing either phase — also covers agent-readiness (feed discovery, theme-color, reduced-motion, and when to reach for the standard plugins vs. hand-rolling) |
